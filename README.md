...
Надо сделать:
+1. миникарта
+2. спавн выходов, которые будут открываться только тогда, когда игрок убьёт всех врагов на уровне
+3. счётчик врагов на уровне
-4. новых врагов
-5. добавить разным предмет особенности поведения(класс для каждого предмета?!)
...
-13. жизни игрока (по сердцам) и период неуязвимости
...
-18. доработать карту убрать костыли
-19. убрать костыли в Animator
-20. создание новых элементов интерфейса
```
